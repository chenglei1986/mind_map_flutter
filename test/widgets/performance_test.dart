...
import '../../lib/src/rendering/mind_map_painter.dart';
import '../../lib/src/layout/node_layout.dart';
...
void main() {
  group('Widget Performance Optimizations', () {
    ...
    testWidgets('should support hot reload without losing state', (tester) async {
    ...
    testWidgets('should not recalculate layout when data hash is unchanged', (tester) async {
    ...
    testWidgets('should handle rapid state updates efficiently', (tester) async {
    ...
    testWidgets('should not crash when setState called after dispose', (tester) async {
      // Validates: Requirement 20.5, 20.6
      ...
      expect(() => controller.addChildNode(testData.nodeData.id), returnsNormally);
    });
    
    testWidgets('should optimize shouldRepaint with identity checks', (tester) async {
      // Validates: Requirement 20.5, 20.6
    ...
    testWidgets('should handle controller updates during hot reload', (tester) async {
      // Validates: Requirement 20.5
